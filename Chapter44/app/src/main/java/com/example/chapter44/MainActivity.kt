...
import com.example.chapter44.ui.theme.Chapter44Theme
...
fun ProductRow(id: Int, name: String, quantity: Int){
    Row(
        ...
        Text(name, modifier = Modifier
            .weight(0.2f))
        Text(quantity.toString(), modifier = Modifier
            .weight(0.2f))
    }
}
...
fun ScreenSetup(viewModel: MainViewModel) {
    ...
    val allProduct by viewModel.allProducts.observeAsState(listOf())
